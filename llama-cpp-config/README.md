...
- No external INI crate: `ini.rs` is a hand-rolled INI reader/writer (~340 lines plus tests) with an explicit behavioral contract in its header (case/whitespace-tolerant section lookup, comment preservation, EOL detection, atomic writes).
